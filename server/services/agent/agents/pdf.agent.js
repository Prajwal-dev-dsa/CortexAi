    ...
    try {
        ...
        if (creditStatus === 400) {
            return {
                ...state,
                aiResponse:
                    "Sorry, you don't have enough credits to use this agent. Please top up your balance in the billing section.",
            };
        }
    ...
    `;
        ...
        try {
            ...
            return {
                ...state,
                aiResponse:
                    "I encountered an error parsing the document outline. Please try requesting the PDF again.",
            };
        }
        ...
        const downloadUrl = await uploadToCloudinary(pdfBuffer, fileName, "raw");
        ...
        if (error.status === 429) {
            return {
                ...
                aiResponse:
                    error.message ||
                    "Sorry, you have exceeded the rate limit. Please try again later.",
            };
        }
        return {
            ...state,
            aiResponse:
                "Sorry, I encountered an issue generating your PDF. Please try again.",
        };
    }
};